...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "RainyDay", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<RainyDayContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "RainyDay API v1");
